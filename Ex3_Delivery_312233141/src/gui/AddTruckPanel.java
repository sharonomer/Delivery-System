...
public class AddTruckPanel extends JPanel {
	...
	public AddTruckPanel() {
		...
		JLabel minivanIcon = new JLabel(" ");
		minivanIcon.setBounds(128, 206, 326, 125);
//		minivanIcon.setIcon(new ImageIcon("img/minivan_side_icon.png"));
		minivanIcon.setIcon(new ImageIcon(getClass().getClassLoader().getResource("minivan_side_icon.png")));
		minivanIcon.setVisible(true);
		add(minivanIcon);
		JLabel vanIcon = new JLabel(" ");
		vanIcon.setBounds(128, 206, 326, 125);
//		vanIcon.setIcon(new ImageIcon("img/van_side_icon.png"));
		vanIcon.setIcon(new ImageIcon(getClass().getClassLoader().getResource("van_side_icon.png")));
		vanIcon.setVisible(false);
		add(vanIcon);
		JLabel tankTruckIcon = new JLabel(" ");
		tankTruckIcon.setBounds(128, 206, 326, 125);
//		tankTruckIcon.setIcon(new ImageIcon("img/tanktruck_side_icon.png"));
		tankTruckIcon.setIcon(new ImageIcon(getClass().getClassLoader().getResource("tanktruck_side_icon.png")));
		tankTruckIcon.setVisible(false);
		add(tankTruckIcon);
		JLabel mailTruckIcon = new JLabel(" ");
		mailTruckIcon.setBounds(128, 206, 326, 125);
//		mailTruckIcon.setIcon(new ImageIcon("img/mailtruck_side_icon.png"));
		mailTruckIcon.setIcon(new ImageIcon(getClass().getClassLoader().getResource("mailtruck_side_icon.png")));
		mailTruckIcon.setVisible(false);
		add(mailTruckIcon);
...
//		kiaIcon.setIcon(new ImageIcon("img/kia.png"));
		...
		JLabel lblNewUserInfo = new JLabel("New Truck:");
		...
		JLabel lblTruckType = new JLabel("Truck type:");
		lblTruckType.setForeground(new Color(255, 255, 255));
		lblTruckType.setFont(new Font("Tahoma", Font.BOLD, 15));
		lblTruckType.setBounds(10, 148, 109, 18);
		add(lblTruckType);
		
		DefaultComboBoxModel<E_TypeTruck> comboModel2 = new DefaultComboBoxModel<E_TypeTruck>(E_TypeTruck.values());
		JComboBox<E_TypeTruck> comboBox3 = new JComboBox<E_TypeTruck>(comboModel2);
		comboBox3.setBounds(109, 149, 109, 20);
		comboBox3.addItemListener(new ItemListener() {
			@Override
			public void itemStateChanged(ItemEvent e) {
				// TODO Auto-generated method stub
				E_TypeTruck type = (E_TypeTruck)comboBox3.getSelectedItem();
				if(type.equals(Utils.E_TypeTruck.MINIVAN)) {
					vanIcon.setVisible(false);
					tankTruckIcon.setVisible(false);
					mailTruckIcon.setVisible(false);
					minivanIcon.setVisible(true);
				}
				else if(type.equals(Utils.E_TypeTruck.VAN)) {
					minivanIcon.setVisible(false);
					tankTruckIcon.setVisible(false);
					mailTruckIcon.setVisible(false);
					vanIcon.setVisible(true);
				}
				else if(type.equals(Utils.E_TypeTruck.TANK_TRUCK)) {
					minivanIcon.setVisible(false);
					vanIcon.setVisible(false);
					mailTruckIcon.setVisible(false);
					tankTruckIcon.setVisible(true);
				}
				else if(type.equals(Utils.E_TypeTruck.MAIL_TRUCK)) {
					minivanIcon.setVisible(false);
					vanIcon.setVisible(false);
					tankTruckIcon.setVisible(false);
					mailTruckIcon.setVisible(true);
				}
				else {
					minivanIcon.setVisible(false);
					vanIcon.setVisible(false);
				...
				if(!not8Chars.isVisible()&&!noDrivers.isVisible()&&!lblDriverInUse.isVisible()&&
					...
					try{
						if(sys.getAllVehiclesMap().containsKey(vin)){
							...
							sys.addTruck(vin, color.getText(),(E_ModelType) comboBox.getSelectedItem(),
									(long) comboBox2.getSelectedItem(), (E_TypeTruck) comboBox3.getSelectedItem());
							String p="";
							for(Driver d:sys.allDrivers())
