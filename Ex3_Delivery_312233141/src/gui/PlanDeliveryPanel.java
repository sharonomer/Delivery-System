...
public class PlanDeliveryPanel extends JPanel {
	...
	/**
	 * Panel for creating new delivery routes for trucks.
	 */
	public PlanDeliveryPanel() {
		setBackground(new Color(25, 25, 112));		
		setLayout(null);
		this.setBounds(0, 0, 464, 411);
		
		JLabel lblLoadTruck = new JLabel("Delivery route:");
		...
		btnLoad.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(comboBoxTruck.getSelectedItem()==null||comboBoxWhId.getSelectedItem()==null||comboBoxWhId2.getSelectedItem()==null)
					...
					sys.addTruckRoute((String)comboBoxTruck.getSelectedItem(),
							sys.getAllWareHouses().get((Integer)comboBoxWhId.getSelectedItem()),
							sys.getAllWareHouses().get((Integer)comboBoxWhId2.getSelectedItem()));
					SysData.getInstance().setTruckDeliveryRoute(sys.getTruckDeliveryRoute());
